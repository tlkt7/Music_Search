...
class TableViewController: UITableViewController, UISearchBarDelegate {
    ...
    var musicSearchArray: [ItunesMusic] = []
    ...
    override func viewDidLoad() {
        ...
        //сюда попадает запрос по нашему поиску
        func searchMusic(term: String){
            ...
            AF.request("https://itunes.apple.com/search", method:  .get, parameters: parameters).responseData { response in
                ...
                if let data = response.data {
                    ...
                    print(resultString) //Преобразует данные в String, визуально чисто для нас
                }
                ...
                if response.response?.statusCode == 200 {
                    ...
                    if let array = json["results"].array {
                        for item in array {
                            ...
                            self.musicSearchArray.append(music)
                        }
                    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Вызываем функцию
        cell.setData(music: musicSearchArray[indexPath.row])
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vc.music = musicSearchArray[indexPath.row]
